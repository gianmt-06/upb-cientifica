...
const (
	...
	FilesRoute_GetHomeFiles_FullMethodName      = "/pb.FilesRoute/GetHomeFiles"
...
type FilesRouteClient interface {
	...
	GetHomeFiles(ctx context.Context, in *GetHomeFilesRequest, opts ...grpc.CallOption) (*GetHomeFilesResponse, error)
...
func (c *filesRouteClient) GetHomeFiles(ctx context.Context, in *GetHomeFilesRequest, opts ...grpc.CallOption) (*GetHomeFilesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetHomeFilesResponse)
	err := c.cc.Invoke(ctx, FilesRoute_GetHomeFiles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FilesRouteServer interface {
	...
	GetHomeFiles(context.Context, *GetHomeFilesRequest) (*GetHomeFilesResponse, error)
...
func (UnimplementedFilesRouteServer) GetHomeFiles(context.Context, *GetHomeFilesRequest) (*GetHomeFilesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHomeFiles not implemented")
}
...
func _FilesRoute_GetHomeFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetHomeFilesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FilesRouteServer).GetHomeFiles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FilesRoute_GetHomeFiles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FilesRouteServer).GetHomeFiles(ctx, req.(*GetHomeFilesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FilesRoute_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetHomeFiles",
			Handler:    _FilesRoute_GetHomeFiles_Handler,
		},
		{
	...
	Metadata: "src/proto/fileserver.proto",
}
